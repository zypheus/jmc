...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2 custom-margin">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('library.books.trash') }}" class="btn btn-outline-danger">Trash</a>
    </div>
</div>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <div class="d-inline-flex gap-2">
                                <a href="{{ route('library.book.show', $book->id) }}" class="btn btn-sm btn-primary">View</a>
                                <form action="{{ route('library.books.unarchive', $book->id) }}" method="POST" class="d-inline">
                                    @csrf
