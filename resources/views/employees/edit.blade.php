...
<div class="container mt-5 mb-5">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form id="employeeForm" method="POST" action="{{ route('library.employees.update', $employee->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="{{ route('library.employees.index') }}" class="btn btn-secondary px-4">Back</a>
                </div>
            </form>
        </div>
    </div>
