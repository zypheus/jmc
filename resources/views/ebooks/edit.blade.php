...
<div class="ebooks-page">
    <header class="ebooks-page__hero">
        ...
        <div class="ebooks-page__hero-actions">
            <a href="{{ route('library.ebooks.index') }}" class="ebooks-btn ebooks-btn--outline">← Collection</a>
            @if($ebook->link)
    ...
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="ebooks-card ebooks-form">
                <form action="{{ route('library.ebooks.update', $ebook->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex flex-wrap gap-2 mt-3">
                        ...
                        <a href="{{ route('library.ebooks.index') }}" class="ebooks-btn ebooks-btn--outline">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
