...
<div class="ebooks-page">
    <header class="ebooks-page__hero">
        ...
        <div class="ebooks-page__hero-actions">
            <a href="{{ route('library.book.index') }}" class="ebooks-btn ebooks-btn--outline">← Catalog</a>
            <a href="{{ route('library.ebooks.create') }}" class="ebooks-btn ebooks-btn--primary">+ Add e-resource</a>
        </div>
    </header>
    ...
    <div class="ebooks-index-layout">
        <aside class="ebooks-sidebar">
            ...
            <form method="GET" action="{{ route('library.ebooks.index') }}">
                ...
                <div class="ebooks-sidebar-actions">
                    ...
                    @if($hasActiveFilter)
                        <a href="{{ route('library.ebooks.index') }}" class="ebooks-btn ebooks-btn--outline w-100">Clear filters</a>
                    @endif
                </div>
            </form>
        </aside>
                                ...
                                @foreach ($ebooks as $ebook)
                                    <tr>
                                        ...
                                        <td class="text-end text-nowrap">
                                            ...
                                            @endif
                                            <a href="{{ route('library.ebooks.edit', $ebook->id) }}"
                                               class="ebooks-btn ebooks-btn--outline ebooks-btn--sm">Edit</a>
                                            <form action="{{ route('library.ebooks.destroy', $ebook->id) }}" method="POST" class="d-inline"
            ...
            @else
                <div class="ebooks-card ebooks-empty">
                    ...
                    @if($hasActiveFilter)
                        ...
                        <a href="{{ route('library.ebooks.index') }}" class="ebooks-btn ebooks-btn--outline">Clear filters</a>
                    @else
                        <p class="mb-2">No e-resources in the collection yet.</p>
                        <a href="{{ route('library.ebooks.create') }}" class="ebooks-btn ebooks-btn--primary">Add first e-resource</a>
                    @endif
                </div>
            @endif
        </main>
