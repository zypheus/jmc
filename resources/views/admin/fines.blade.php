...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form method="POST" action="{{ route('library.fines.update') }}">
                @csrf
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const holidaysListUrl = @json(route('library.holidays.list'));
    const holidaysAllUrl = @json(route('library.holidays.all'));
    const holidaysToggleUrl = @json(route('library.holidays.toggle'));
