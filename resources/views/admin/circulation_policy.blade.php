...
<div class="container py-2 policy-shell circ-admin circ-policy-compact">
    <div class="d-flex justify-content-between align-items-center mb-2 flex-wrap gap-2 circ-policy-page-head">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a href="{{ route('library.logs.index') }}" class="btn btn-outline-secondary btn-sm">Circulation desk</a>
            <a href="{{ route('library.fines.outstanding') }}" class="btn btn-outline-secondary btn-sm">Outstanding fines</a>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('library.circulation.policy.update') }}" id="circulationPolicyForm">
        @csrf
