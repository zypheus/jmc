...
use App\Domain\Library\Services\LibraryHoldingsReport1ExcelWriter;
use App\Domain\Library\Services\LibraryHoldingsReport2ExcelWriter;
use App\Domain\Library\Services\LibraryHoldingsReportBuilder;
...
class LibraryHoldingsReportController extends Controller
{
    public function create()
    {
        ...
        return Inertia::render('Library/Reports/Holdings', [
            'programs' => $programs,
        ]);
    }
    ...
    public function download(Request $request, LibraryHoldingsReportBuilder $builder)
    {
        ...
        $program = LibraryProgram::findOrFail($validated['program_id']);
